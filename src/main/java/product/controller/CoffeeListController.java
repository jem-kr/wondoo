...
public class CoffeeListController extends SuperClass {
	private final String command = "cfList.pr";
	...
	public ModelAndView doGet(
		...
		int totalCount = dao.SelectTotalCoffeeCount(param.getMode(), "%" + param.getKeyword() + "%");
		...
		// 해당 목록 가져오기
		List<Product> lists = this.dao.SelectAllCoffeeData(pageInfo.getOffset(), pageInfo.getLimit(),
