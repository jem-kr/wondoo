...
public class SuperClass { // implementsSuperController, Validator{
	...
	// 현재 날짜 구하기 --> 원데이 클래스 부분에서 필요
	protected DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyyMMdd"); // 날짜 형식 구하기
	protected LocalDate _today = LocalDate.now();
	protected String today = _today.format(formatter);
