...
// 원데이 클래스와 상품에서 사용할 페이징 처리 클래스
// 상품과 클래스는 최대 9개까지 한페이지에 나와야하기때문에 따로 구현함 
public class FlowParameters2 {
	// 페이징 처리 관련 변수들
	...
	public FlowParameters2() { }
	
	public FlowParameters2(String pageNumber, String pageSize, String mode, String keyword) {
